...
def moveJointSpace(joint1, joint2, joint3, joint4, time):
    rospy.wait_for_service('/robot2_controller/goal_joint_space_path')
    try:
        SetJointSpaceGoal = rospy.ServiceProxy('/robot2_controller/goal_joint_space_path', SetJointPosition)
