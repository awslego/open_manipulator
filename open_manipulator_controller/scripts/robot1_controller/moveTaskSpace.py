...
def moveTaskSpace(x, y, z, time):
    rospy.wait_for_service('/robot1_controller/goal_task_space_path')
    try:
        SetTaskSpaceGoal = rospy.ServiceProxy('/robot1_controller/goal_task_space_path', SetKinematicsPose)
