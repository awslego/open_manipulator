...
def moveTaskSpace(x, y, z, time):
    rospy.wait_for_service('/open_manipulator/goal_task_space_path')
    try:
        SetTaskSpaceGoal = rospy.ServiceProxy('/open_manipulator/goal_task_space_path', SetKinematicsPose)
